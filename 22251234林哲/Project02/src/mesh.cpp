...
Vertex::Vertex(glm::vec3 pos, glm::vec3 nor, glm::vec2 tex) : Position(pos), Normal(nor), TexCoords(tex), Tangent(0), Bitangent(0) { }
...
// 生成球的顶点和索引
void generate_sphere_vertices(vector<Vertex>& polygon_vertices, vector<unsigned int>& polygon_indices, int xymax = 100)
{
